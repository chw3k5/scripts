...
# this sweep returns exacty 501 point and takes exactly 48 sec to run
# with feedback 0 (off) it goes from 0-7 mV
$sweepcommand = "sweep 0 65100 52600 250 \n";
...
#sleep(240);
sleep(25);  # increase w/ number of points, or loop w/ recv() until you get all data
open(FILE, '>sweep.dat');
