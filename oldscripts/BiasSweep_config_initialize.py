...
high_res_min  = 1.3 # mV
high_res_max  = 2.5 # mV
high_res_meas = 5 # number of measurments while the high resilution voltage range

TPSampleFrequency = 100 # samples per second
TPSampleTime      =   1 # seconds  

sisvsweep_min  = 0.0 # mV, -6 mV min
sisvsweep_max  = 3.0 # mV,  6 mV max
...
magisweep_min  = 30.0 # mA, -42 in min 
magisweep_max  = 29.9 # mA,  42 is max
magisweep_step = -1.0 # mA

magpotsweep_min  = 100000 # potentiometer position,       0 is min 
magpotsweep_max  =  99999 # potentiometer position, 1279797 is max
...
sisisweep_min  =  13.0 # uA
sisisweep_max  =  13.1 # uA
...
FiveMinEmail    = False
PeriodicEmail   = False
seconds_per_email = 1200 # seconds (60 s = 1 min, 3600 s = 1 hour ) 
