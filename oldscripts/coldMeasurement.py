def coldMeasurement(doWide, doNarrow, N, datadir, LO, IFband, magpot, mA_mag, UCA_voltage, Ynum, Offnum, WideSweepStart, WideSweepStop, WideSweepStep, NarrowSweepStart, NarrowSweepStop, NarrowSweepStep):
    import sys
    from setfeedback import setfeedback
    from IVsweeps import IVsweeps
    ############# start 77K measurements
    ### Wide band sweep at 77K
    if doWide == True:
        ...
        if status == False:
            ...
            sys.exit()
        N = N + 1
    # end of wide band 77K measurement       
    ### Narrow
    if doNarrow == True:
