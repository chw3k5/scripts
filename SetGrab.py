...
from profunc import getproYdata, GetProDirsNames, getproparams, getmultiParams, getproSweep
...
def winpath(setname):
    setname1 = str(setname)
    setname2 = setname1.replace('/Users/chw3k5/Documents/Grad_School/', 'C:\\Users\\MtDewar\\Documents\\')
    winpath  = setname2.replace('/', '\\')
    return winpath

#if platform == 'win32':
#    fullpath = winpath(fullpaths)
